...
\title[Predicción de resultados de fútbol]{Análisis Comparativo de Clasificadores para la
Predicción Multiclase de Resultados de Fútbol}
\subtitle{Minería de Datos (CC442) --- 2026-I}
\author[Pérez, Pezo, Trujillo]{Arbués Pérez Villegas \and Sergio Pezo Jimenez \and Luis Trujillo Serva}
...
\begin{frame}[plain]
  ...
  Repositorio del proyecto y artículo IEEE disponibles.\\[1em]
  \emph{¿Preguntas?}
  \vfill
\end{frame}
